...
const PDF_TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  fr: {
    ...
    taxBase: "Base HT",
    ivaOn: "TVA (sur base)",
    irpfRetention: "Retenue a la source",
    ...
    dueLabel: "Echeance",
    currency: "Devise",
    paymentData: "COORDONNEES BANCAIRES",
    holder: "Titulaire",
    notesLabel: "Notes",
  },
  de: {
    ...
    amount: "Betrag",
    taxBase: "Nettobetrag",
    ivaOn: "MwSt. (auf Basis)",
    irpfRetention: "Quellensteuer",
    totalInvoice: "GESAMTBETRAG",
  ...
  pt: {
    ...
    irpf: "Retencao",
    amount: "Valor",
    taxBase: "Base tributavel",
    ivaOn: "IVA (s/base)",
    irpfRetention: "Retencao na fonte",
    totalInvoice: "TOTAL FATURA",
  ...
  it: {
    ...
    taxBase: "Imponibile",
    ivaOn: "IVA (su base)",
    irpfRetention: "Ritenuta d'acconto",
    ...
    dueLabel: "Scadenza",
    currency: "Valuta",
    paymentData: "COORDINATE BANCARIE",
    holder: "Intestatario",
    notesLabel: "Note",
  },
  ca: {
